...
| **Observed HTTP Methods (e.g., POST)** | Record of HTTP method usage patterns, such as POST.                                                                                                       | Although encrypted, the pattern of methods can be identified and correlated with typical exfiltration behavior.               |
...
| **Session Start and End Data**        | Observation of TLS handshake flows, including session start and end timestamps.                                                                           | Atypical patterns of open and closed sessions may indicate continuous or repeated exfiltration processes.                     |
